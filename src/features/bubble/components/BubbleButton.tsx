...
const defaultButtonColor = '#18443C';
const defaultIconColor = 'var(--color-brand-light, #FFFFFF)';
  ...
  return (
    <Show when={!isSmallScreen() || !props.isBotOpened} keyed>
      <button
        ...
        style={{
          'background-color':  'var(--color-brand-dark, #18443C)',
          'z-index': 42424242,
      ...
      >
        ...
        <Show when={props.customIconSrc}>
          <img
            ...
            class={'rounded-full object-contain' + (props.isBotOpened ? 'scale-0 opacity-0' : 'scale-100 opacity-100')}
            style={{
