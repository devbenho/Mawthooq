...
const defaultBackgroundColor = '#F5F9F8'; // Light green tint for bot bubbles
const defaultTextColor = '#18443C'; // Dark green text
const defaultFontSize = 16;
const defaultFeedbackColor = '#8BFF00'; // Lime green for feedback buttons
