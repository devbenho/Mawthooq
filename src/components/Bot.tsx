    ...
    <>
      {startInputType() === 'formInput' && messages().length === 1 ? (
        ...
        >
          ...
          {props.showTitle ? (
            <div
              ...
              style={{
                ...
                'font-family': `'Cairo', 'Tajawal', 'Noto Sans Arabic', 'Open Sans', sans-serif`,
                'font-size': '1.5rem',
                'font-weight': 'bold',
            ...
            >
              ...
              <span class="ml-4 p-4">Mawthooq - موثوق</span>
          ...
          <div class="flex flex-col w-full h-full justify-start z-0" style={{ 'min-height': '0' }}>
            {/* Logo always visible above chat messages */}
            <div class="w-full flex justify-center items-center mt-12" style={{ 'min-height': '80px' }}>
              <img
                src="/logo.png"
                alt="Insurance Authority Logo"
                style={{ 'max-width': '200px', 'max-height': '120px', width: 'auto', height: 'auto', display: 'block', 'object-fit': 'contain' }}
              />
            </div>
            <div
              ref={chatContainer}
              ...
              style={{ 'min-height': 0, 'max-height': 'calc(100vh - 200px)' }}
            >
              <For each={messages()}>
                {(message, index) => {
                  return (
